...
type
  ...
  // type of the scope
  TScopeType = (stGlobal, stFunction, stBlock);
  ...
  TScope = record
    ...
    FreeVar: TList<ShortString>;

    // set of own cell variables
    Cells: TList<ShortString>;
...
begin
  ...
  Scope.FreeVar := TList<ShortString>.Create;
  Scope.Cells := TList<ShortString>.Create;
end;
